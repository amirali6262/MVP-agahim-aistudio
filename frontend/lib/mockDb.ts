...
let _objectionTemplates: ObjectionTemplate[] = isMockDataEnabled ? [
  ...
  {
    id: 'obj-pit-001',
    template_name: 'مالیات بر عملکرد ـ از تهیه گزارش رسیدگی و صدور برگ تشخیص تا قطعیت مالیات یا ارجاع اختلاف به هیأت حل اختلاف بدوی',
    description: 'فرایند کامل مالیات بر عملکرد اشخاص حقیقی و حقوقی از مرحله حسابرسی و تهیه گزارش رسیدگی تا صدور برگ قطعی یا ارجاع به هیأت حل اختلاف بدوی. مبنا: مواد ۲۰۳، ۲۰۸، ۲۱۰، ۲۱۹، ۲۳۷، ۲۳۸، ۲۳۹، ۲۴۴ قانون مالیات‌های مستقیم.',
    ...
    tax_type_overrides: [
      {
        ...
        statutory_deadline_override: 30,
        deadline_unit: 'روز',
        legal_reference_override: 'ماده ۲۳۸ و ۲۴۴ ق.م.م (مهلت ثبت ۳۰ روز - مهلت رسیدگی ۴۵ روز)',
        special_tribunal_name: 'هیأت حل اختلاف مالیاتی بدوی (ماده ۲۴۴ ق.م.م)',
        notes: 'طبق ماده ۱۵۶ ق.م.م، چنانچه ظرف یک سال از تاریخ تسلیم اظهارنامه برگ تشخیص صادر نشود، ارقام ابرازی خودکار قطعی می‌گردد.',
        is_custom_path_active: true,
      },
    ...
    steps: [
      ...
      {
        id: 'pit-001',
        title: 'PIT-001: تهیه گزارش رسیدگی مالیات بر عملکرد',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 0,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'واحد حسابرسی یا رسیدگی مالیاتی اقدام به انجام حسابرسی، تهیه گزارش رسیدگی و ثبت مبانی تشخیص می‌کند.',
        fields: [
          { id: 'pit-001-f1', label: 'شماره گزارش', key: 'report_number', type: 'text', required: true, placeholder: 'REP-1404-001' },
          { id: 'pit-001-f2', label: 'تاریخ گزارش', key: 'report_date', type: 'date', required: true },
          { id: 'pit-001-f3', label: 'اعضای گروه رسیدگی', key: 'audit_team', type: 'text', required: true },
          { id: 'pit-001-f4', label: 'روش حسابرسی', key: 'audit_method', type: 'select', required: true, options: ['حسابرسی مبتنی بر ریسک', 'حسابرسی تفصیلی', 'حسابرسی نمونه‌گیری'] },
          { id: 'pit-001-f5', label: 'اسناد بررسی‌شده', key: 'documents_reviewed', type: 'text', required: false },
          { id: 'pit-001-f6', label: 'اقلام مورد قبول', key: 'accepted_items', type: 'text', required: false },
          { id: 'pit-001-f7', label: 'اقلام ردشده', key: 'rejected_items', type: 'text', required: false },
          { id: 'pit-001-f8', label: 'تعدیلات', key: 'adjustments', type: 'text', required: false },
          { id: 'pit-001-f9', label: 'درآمد مشمول مالیات محاسبه‌شده', key: 'calculated_taxable_income', type: 'number', required: true, placeholder: '۱۵,۰۰۰,۰۰۰,۰۰۰' },
          { id: 'pit-001-f10', label: 'مالیات محاسبه‌شده', key: 'calculated_tax', type: 'number', required: true, placeholder: '۳,۷۵۰,۰۰۰,۰۰۰' },
          { id: 'pit-001-f11', label: 'جرائم', key: 'penalties', type: 'number', required: false },
          { id: 'pit-001-f12', label: 'پیوست‌ها', key: 'attachments', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-002',
        title: 'PIT-002: صدور برگ تشخیص مالیات بر عملکرد',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 0,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'مقام مجاز سازمان امور مالیاتی پس از کنترل گزارش رسیدگی، برگ تشخیص مالیات را صادر می‌کند.',
        fields: [
          { id: 'pit-002-f1', label: 'شماره برگ تشخیص', key: 'assessment_notice_number', type: 'text', required: true, placeholder: 'NOTICE-1404-7721' },
          { id: 'pit-002-f2', label: 'تاریخ صدور', key: 'issue_date', type: 'date', required: true },
          { id: 'pit-002-f3', label: 'سال عملکرد', key: 'fiscal_year', type: 'text', required: true, placeholder: '۱۴۰۳' },
          { id: 'pit-002-f4', label: 'درآمد مشمول مالیات', key: 'taxable_income', type: 'number', required: true },
          { id: 'pit-002-f5', label: 'مالیات تشخیصی', key: 'assessed_tax', type: 'number', required: true },
          { id: 'pit-002-f6', label: 'مالیات ابرازی', key: 'declared_tax', type: 'number', required: true },
          { id: 'pit-002-f7', label: 'پرداخت‌های قبلی', key: 'previous_payments', type: 'number', required: false },
          { id: 'pit-002-f8', label: 'مابه‌التفاوت', key: 'difference', type: 'number', required: false },
          { id: 'pit-002-f9', label: 'جرائم', key: 'penalties', type: 'number', required: false },
          { id: 'pit-002-f10', label: 'دلایل تشخیص', key: 'assessment_reasons', type: 'text', required: false },
          { id: 'pit-002-f11', label: 'بارکد یا شناسه سازمانی', key: 'barcode', type: 'text', required: false },
        ],
      },
      {
        id: 'pit-003',
        title: 'PIT-003: ابلاغ برگ تشخیص مالیات بر عملکرد',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 0,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'ابلاغ برگ تشخیص به مودی از طریق سامانه ابلاغ الکترونیکی یا روش قانونی. پس از ثبت ابلاغ معتبر، مهلت ۳۰ روزه اعتراض شروع می‌شود.',
        fields: [
          { id: 'pit-003-f1', label: 'تاریخ بارگذاری در سامانه', key: 'upload_date', type: 'date', required: true },
          { id: 'pit-003-f2', label: 'تاریخ اولین پیامک', key: 'first_sms_date', type: 'date', required: false },
          { id: 'pit-003-f3', label: 'تاریخ مشاهده توسط مودی', key: 'view_date', type: 'date', required: false },
          { id: 'pit-003-f4', label: 'تاریخ ابلاغ مؤثر', key: 'effective_service_date', type: 'date', required: true },
          { id: 'pit-003-f5', label: 'نوع ابلاغ', key: 'service_type', type: 'select', required: true, options: ['واقعی', 'قانونی'] },
          { id: 'pit-003-f6', label: 'روش ابلاغ', key: 'service_method', type: 'select', required: true, options: ['الکترونیکی', 'کتبی حضوری', 'پستی'] },
          { id: 'pit-003-f7', label: 'شخص دریافت‌کننده', key: 'recipient_name', type: 'text', required: false },
          { id: 'pit-003-f8', label: 'مستند ابلاغ', key: 'service_document', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-004',
        title: 'PIT-004: دریافت یا مشاهده گزارش مبنای تشخیص (اختیاری)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی می‌تواند درخواست دریافت جزئیات گزارش مبنای برگ تشخیص را ثبت کند. این اقدام مهلت اعتراض را متوقف یا تمدید نمی‌کند.',
        fields: [
          { id: 'pit-004-f1', label: 'تاریخ درخواست', key: 'request_date', type: 'date', required: false },
          { id: 'pit-004-f2', label: 'روش درخواست', key: 'request_method', type: 'select', required: false, options: ['الکترونیکی', 'کتبی'] },
          { id: 'pit-004-f3', label: 'اقلام درخواستی', key: 'requested_items', type: 'text', required: false },
          { id: 'pit-004-f4', label: 'تاریخ پاسخ سازمان', key: 'response_date', type: 'date', required: false },
          { id: 'pit-004-f5', label: 'فایل گزارش', key: 'report_file', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-005',
        title: 'PIT-005: مهلت تصمیم مؤدی (۳۰ روز از تاریخ ابلاغ)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی باید ظرف ۳۰ روز از تاریخ ابلاغ معتبر یکی از اقدامات زیر را انجام دهد: قبول کتبی، پرداخت مالیات، ترتیب پرداخت، ثبت اعتراض، یا عدم اقدام.',
      },
      // ── شاخه قبول برگ تشخیص ──
      {
        id: 'pit-010',
        title: 'PIT-010: اعلام قبول کتبی برگ تشخیص',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'AGREEMENT_END',
        actor: 'TAXPAYER',
        note: 'مؤدی کتبی برگ تشخیص را قبول می‌کند. مأخذ و مالیات مندرج قطعی می‌شود.',
        fields: [
          { id: 'pit-010-f1', label: 'تاریخ قبول', key: 'acceptance_date', type: 'date', required: true },
          { id: 'pit-010-f2', label: 'دامنه قبول', key: 'acceptance_scope', type: 'select', required: true, options: ['قبول کامل', 'قبول بخشی'] },
          { id: 'pit-010-f3', label: 'متن اعلام قبول', key: 'acceptance_text', type: 'text', required: false },
          { id: 'pit-010-f4', label: 'سند امضاشده', key: 'signed_document', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-011',
        title: 'PIT-011: پرداخت یا ترتیب پرداخت براساس برگ تشخیص',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی مالیات را پرداخت یا ترتیب پرداخت می‌دهد. در صورت عدم مانده، مرحله با وضعیت not_required_zero_balance تکمیل شود.',
        fields: [
          { id: 'pit-011-f1', label: 'مالیات تشخیصی', key: 'assessed_tax', type: 'number', required: true },
          { id: 'pit-011-f2', label: 'پرداخت‌های قبلی', key: 'previous_payments', type: 'number', required: false },
          { id: 'pit-011-f3', label: 'مبلغ قابل پرداخت', key: 'amount_due', type: 'number', required: true },
          { id: 'pit-011-f4', label: 'مبلغ پرداخت‌شده', key: 'amount_paid', type: 'number', required: false },
          { id: 'pit-011-f5', label: 'تاریخ پرداخت', key: 'payment_date', type: 'date', required: false },
          { id: 'pit-011-f6', label: 'شناسه پرداخت', key: 'payment_id', type: 'text', required: false },
          { id: 'pit-011-f7', label: 'درخواست تقسیط', key: 'installment_request', type: 'checkbox', required: false },
        ],
      },
      {
        id: 'pit-012',
        title: 'PIT-012: قطعیت ناشی از قبول یا رفع اختلاف',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'FINAL_NOTICE_ISSUANCE',
        actor: 'TAX_AUTHORITY',
        note: 'پس از قبول کتبی، پرداخت، ترتیب پرداخت، یا رفع کامل اختلاف طبق ماده ۲۳۸، دستور قطعیت و برگ قطعی صادر می‌شود.',
      },
      // ── شاخه اعتراض ماده ۲۳۸ ──
      {
        id: 'pit-020',
        title: 'PIT-020: ثبت اعتراض به برگ تشخیص و درخواست رسیدگی مجدد ماده ۲۳۸',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی یا وکیل تام‌الاختیار ظرف ۳۰ روز از تاریخ ابلاغ، اعتراض خود را ثبت می‌کند. ثبت اعتراض فقط به سامانه محدود نیست.',
        fields: [
          { id: 'pit-020-f1', label: 'شماره اعتراض', key: 'objection_number', type: 'text', required: true, placeholder: 'OBJ-1404-8812' },
          { id: 'pit-020-f2', label: 'تاریخ و ساعت ثبت', key: 'registration_datetime', type: 'date', required: true },
          { id: 'pit-020-f3', label: 'روش ثبت', key: 'registration_method', type: 'select', required: true, options: ['الکترونیکی', 'کتبی حضوری', 'پستی'] },
          { id: 'pit-020-f4', label: 'ثبت داخل یا خارج از مهلت', key: 'within_deadline', type: 'select', required: true, options: ['داخل مهلت', 'خارج از مهلت'] },
          { id: 'pit-020-f5', label: 'مبلغ کل مورد اعتراض', key: 'total_objection_amount', type: 'number', required: true },
          { id: 'pit-020-f6', label: 'مبلغ مورد قبول', key: 'accepted_amount', type: 'number', required: false },
          { id: 'pit-020-f7', label: 'مبلغ مورد اختلاف', key: 'disputed_amount', type: 'number', required: true },
          { id: 'pit-020-f8', label: 'اقلام مورد اعتراض', key: 'objection_items', type: 'text', required: true, placeholder: 'رد بخشی از هزینه اجاره و استهلاک' },
          { id: 'pit-020-f9', label: 'شرح هر اعتراض', key: 'objection_details', type: 'text', required: false },
          { id: 'pit-020-f10', label: 'دلایل', key: 'reasons', type: 'text', required: false },
          { id: 'pit-020-f11', label: 'مواد قانونی مورد استناد', key: 'legal_references', type: 'text', required: false, placeholder: 'ماده ۲۳۸ ق.م.م' },
          { id: 'pit-020-f12', label: 'پیوست‌ها', key: 'attachments', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-021',
        title: 'PIT-021: ارجاع داخلی اعتراض به مسئول ماده ۲۳۸',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'حوزه کاری اعتراضات و شکایات، پرونده را به مسئول یا مسئولان مربوط موضوع ماده ۲۳۸ ارجاع می‌دهد.',
      },
      {
        id: 'pit-022',
        title: 'PIT-022: رسیدگی مجدد ماده ۲۳۸ (حداکثر ۴۵ روز)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'مسئول یا مسئولان مربوط ظرف ۴۵ روز از تاریخ ثبت درخواست اعتراض، به دلایل و مدارک رسیدگی می‌کنند. عدم حضور مؤدی مانع رسیدگی نیست.',
        fields: [
          { id: 'pit-022-f1', label: 'تاریخ رسیدگی', key: 'review_date', type: 'date', required: true },
          { id: 'pit-022-f2', label: 'نوع رسیدگی', key: 'review_type', type: 'select', required: true, options: ['حضوری', 'غیرحضوری'] },
          { id: 'pit-022-f3', label: 'افراد حاضر', key: 'attendees', type: 'text', required: false },
          { id: 'pit-022-f4', label: 'مدارک بررسی‌شده', key: 'documents_reviewed', type: 'text', required: false },
          { id: 'pit-022-f5', label: 'توضیحات مؤدی', key: 'taxpayer_notes', type: 'text', required: false },
          { id: 'pit-022-f6', label: 'توضیحات سازمان', key: 'authority_notes', type: 'text', required: false },
          { id: 'pit-022-f7', label: 'اقلام مورد اختلاف', key: 'disputed_items', type: 'text', required: true },
          { id: 'pit-022-f8', label: 'نیاز به کارشناسی مجدد', key: 'needs_expert_review', type: 'checkbox', required: false },
          { id: 'pit-022-f9', label: 'صورت‌جلسه', key: 'minutes_file', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-023',
        title: 'PIT-023: صدور قرار بررسی مجدد (اختیاری)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'CONDITIONAL_EXPERT',
        actor: 'TAX_AUTHORITY',
        note: 'در صورت نیاز به بررسی بیشتر، مسئول ماده ۲۳۸ قرار کارشناسی صادر می‌کند. صدور قرار نباید مهلت ۴۵ روزه را خودکار تمدید کند.',
        fields: [
          { id: 'pit-023-f1', label: 'شماره قرار', key: 'order_number', type: 'text', required: true },
          { id: 'pit-023-f2', label: 'تاریخ صدور', key: 'order_date', type: 'date', required: true },
          { id: 'pit-023-f3', label: 'نوع قرار', key: 'order_type', type: 'select', required: true, options: ['بررسی اسناد', 'کارشناسی تخصصی', 'بازرسی میدانی'] },
          { id: 'pit-023-f4', label: 'موضوع قرار', key: 'order_subject', type: 'text', required: true },
          { id: 'pit-023-f5', label: 'مجری قرار', key: 'executor', type: 'text', required: true },
          { id: 'pit-023-f6', label: 'مهلت اجرا', key: 'execution_deadline', type: 'date', required: false },
        ],
      },
      {
        id: 'pit-024',
        title: 'PIT-024: اجرای قرار کارشناسی',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'CONDITIONAL_EXPERT',
        actor: 'TAX_AUTHORITY',
        note: 'کارشناس مجری قرار اقدام به اجرای قرار و تهیه گزارش می‌کند.',
        fields: [
          { id: 'pit-024-f1', label: 'شماره گزارش اجرای قرار', key: 'execution_report_number', type: 'text', required: true },
          { id: 'pit-024-f2', label: 'تاریخ گزارش', key: 'execution_report_date', type: 'date', required: true },
          { id: 'pit-024-f3', label: 'اقدامات انجام‌شده', key: 'actions_taken', type: 'text', required: true },
          { id: 'pit-024-f4', label: 'نتیجه کارشناسی', key: 'expert_result', type: 'text', required: true },
          { id: 'pit-024-f5', label: 'موارد تأییدشده', key: 'confirmed_items', type: 'text', required: false },
          { id: 'pit-024-f6', label: 'موارد ردشده', key: 'rejected_items', type: 'text', required: false },
          { id: 'pit-024-f7', label: 'پیوست‌ها', key: 'attachments', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-025',
        title: 'PIT-025: رسیدگی نهایی ماده ۲۳۸',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'رسیدگی نهایی می‌تواند پس از اجرای قرار یا بدون صدور قرار انجام شود.',
        fields: [
          { id: 'pit-025-f1', label: 'تاریخ رسیدگی نهایی', key: 'final_review_date', type: 'date', required: true },
          { id: 'pit-025-f2', label: 'نتیجه کلی', key: 'overall_result', type: 'select', required: true, options: ['پذیرش کامل اعتراض', 'تعدیل مالیات', 'تأیید برگ تشخیص', 'نتیجه ترکیبی', 'عدم تکمیل رسیدگی'] },
          { id: 'pit-025-f3', label: 'مبلغ تعدیل‌شده', key: 'adjusted_amount', type: 'number', required: false },
          { id: 'pit-025-f4', label: 'مبلغ رفع اختلاف‌شده', key: 'settled_amount', type: 'number', required: false },
          { id: 'pit-025-f5', label: 'مبلغ باقی‌مانده مورد اختلاف', key: 'remaining_disputed', type: 'number', required: false },
          { id: 'pit-025-f6', label: 'سند نتیجه رسیدگی', key: 'result_document', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-026',
        title: 'PIT-026: اعلام نتیجه رسیدگی مجدد به مؤدی',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAX_AUTHORITY',
        note: 'نتیجه رسیدگی مجدد ماده ۲۳۸ به مؤدی اعلام می‌شود. از عبارت final_ruling استفاده نشود.',
        fields: [
          { id: 'pit-026-f1', label: 'تاریخ اعلام نتیجه', key: 'result_announcement_date', type: 'date', required: true },
          { id: 'pit-026-f2', label: 'روش اعلام', key: 'announcement_method', type: 'select', required: true, options: ['سامانه', 'ابلاغ', 'حضوری'] },
          { id: 'pit-026-f3', label: 'وضعیت مشاهده', key: 'view_status', type: 'select', required: false, options: ['مشاهده شده', 'مشاهده نشده'] },
          { id: 'pit-026-f4', label: 'فایل نتیجه', key: 'result_file', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-027',
        title: 'PIT-027: تصمیم مؤدی درباره نتیجه رسیدگی مجدد',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی باید نسبت به نتیجه رسیدگی مجدد اعلام نظر کند. سکوت مؤدی به معنی قبول نیست.',
        fields: [
          { id: 'pit-027-f1', label: 'تاریخ تصمیم', key: 'decision_date', type: 'date', required: true },
          { id: 'pit-027-f2', label: 'تصمیم', key: 'decision', type: 'select', required: true, options: ['پذیرش کامل', 'پذیرش بخشی', 'عدم پذیرش', 'عدم پاسخ'] },
          { id: 'pit-027-f3', label: 'مبلغ پذیرفته‌شده', key: 'accepted_amount', type: 'number', required: false },
          { id: 'pit-027-f4', label: 'مبلغ باقی‌مانده مورد اختلاف', key: 'remaining_disputed', type: 'number', required: false },
        ],
      },
      // ── نتایج رسیدگی ماده ۲۳۸ ──
      {
        id: 'pit-027a',
        title: 'نتیجه A: پذیرش کامل اعتراض (قطعیت بر اساس نتیجه جدید)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'AGREEMENT_END',
        actor: 'TAX_AUTHORITY',
        note: 'اعتراض مؤدی به‌طور کامل پذیرفته شده و اختلاف دیگری باقی نمانده است.',
      },
      {
        id: 'pit-027b',
        title: 'نتیجه B: تعدیل و قبول کامل مؤدی',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'AGREEMENT_END',
        actor: 'TAXPAYER',
        note: 'مالیات تعدیل شده و مؤدی نتیجه را کامل قبول کرده است.',
      },
      {
        id: 'pit-027c',
        title: 'نتیجه C: تأیید برگ تشخیص و قبول مؤدی',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'SETTLEMENT_END',
        actor: 'TAXPAYER',
        note: 'اعتراض پذیرفته نشده و مؤدی برگ تشخیص یا نتیجه رسیدگی را قبول کرده است.',
      },
      {
        id: 'pit-027d',
        title: 'نتیجه D: قبول بخشی و ادامه اختلاف (ارجاع مابه‌الاختلاف)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'NEXT_STAGE',
        actor: 'TAX_AUTHORITY',
        note: 'مؤدی بخشی از نتیجه را قبول کرده و فقط اقلام حل‌نشده به هیأت بدوی ارجاع می‌شود.',
      },
      {
        id: 'pit-027e',
        title: 'نتیجه E: عدم توافق (ارجاع به هیأت بدوی)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'NEXT_STAGE',
        actor: 'TAX_AUTHORITY',
        note: 'برگ تشخیص تأیید شده یا تعدیل مورد قبول مؤدی نیست. اختلاف به هیأت بدوی ارجاع می‌شود.',
      },
      {
        id: 'pit-027f',
        title: 'نتیجه F: عدم پاسخ مؤدی (ارجاع به هیأت بدوی)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'NEXT_STAGE',
        actor: 'TAX_AUTHORITY',
        note: 'مؤدی تا پایان مهلت نتیجه تعدیل را قبول نکرده است. سکوت مؤدی به‌عنوان قبول ثبت نشود.',
      },
      // ── پایان مهلت و ارجاع ──
      {
        id: 'pit-030',
        title: 'PIT-030: پایان مهلت ۳۰ روزه اعتراض (خودکار)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'EXPIRED_END',
        actor: 'TAXPAYER',
        note: 'اگر مؤدی ظرف ۳۰ روز اقدام نکرده باشد، نوع ابلاغ بررسی می‌شود.',
      },
      {
        id: 'pit-031',
        title: 'PIT-031: عدم اعتراض پس از ابلاغ واقعی (قطعیت خودکار)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'FINAL_NOTICE_ISSUANCE',
        actor: 'TAX_AUTHORITY',
        note: 'ابلاغ واقعی بوده و مؤدی اقدام نکرده است. درآمد و مالیات مندرج قطعی شده و برگ قطعی صادر می‌شود.',
      },
      {
        id: 'pit-032',
        title: 'PIT-032: عدم اقدام پس از ابلاغ قانونی (در حکم معترض)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 30,
        gap_unit: 'روز',
        step_nature: 'NEXT_STAGE',
        actor: 'TAX_AUTHORITY',
        note: 'ابلاغ قانونی مشمول تبصره ماده ۲۳۹ بوده و مؤدی اقدام نکرده است. مؤدی در حکم معترض ثبت شده و پرونده به هیأت بدوی ارجاع می‌شود.',
      },
      {
        id: 'pit-040',
        title: 'PIT-040: ارجاع به هیأت حل اختلاف مالیاتی بدوی (نقطه خروج)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 45,
        gap_unit: 'روز',
        step_nature: 'NEXT_STAGE',
        actor: 'TAX_AUTHORITY',
        note: 'پرونده به هیأت حل اختلاف مالیاتی بدوی ارجاع می‌شود. در این نسخه هیأت بدوی فقط نقطه خروج فرایند است.',
        fields: [
          { id: 'pit-040-f1', label: 'شماره ارجاع', key: 'referral_number', type: 'text', required: true },
          { id: 'pit-040-f2', label: 'تاریخ ارجاع', key: 'referral_date', type: 'date', required: true },
          { id: 'pit-040-f3', label: 'علت ارجاع', key: 'referral_reason', type: 'select', required: true, options: ['عدم توافق ماده ۲۳۸', 'عدم پذیرش تعدیل', 'عدم پاسخ مؤدی', 'ارجاع پس از ابلاغ قانونی'] },
          { id: 'pit-040-f4', label: 'مبلغ مورد اختلاف', key: 'disputed_amount', type: 'number', required: true },
          { id: 'pit-040-f5', label: 'نتیجه رسیدگی ماده ۲۳۸', key: 'article_238_result', type: 'text', required: false },
          { id: 'pit-040-f6', label: 'انتخاب نماینده بند ۳ ماده ۲۴۴', key: 'article_244_representative', type: 'select', required: false, options: ['اتاق بازرگانی', 'جامعه حسابداران رسمی', 'اتاق اصناف'] },
        ],
      },
      // ── قطعیت و پرداخت ──
      {
        id: 'pit-050',
        title: 'PIT-050: صدور برگ قطعی مالیات بر عملکرد',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 0,
        gap_unit: 'روز',
        step_nature: 'FINAL_NOTICE_ISSUANCE',
        actor: 'TAX_AUTHORITY',
        note: 'صدور برگ قطعی مالیات پس از تحقق یکی از علل قطعیت.',
        fields: [
          { id: 'pit-050-f1', label: 'شماره برگ قطعی', key: 'final_notice_number', type: 'text', required: true },
          { id: 'pit-050-f2', label: 'تاریخ صدور', key: 'issue_date', type: 'date', required: true },
          { id: 'pit-050-f3', label: 'علت قطعیت', key: 'finalization_reason', type: 'select', required: true, options: ['قبول کتبی', 'پرداخت به مأخذ برگ', 'ترتیب پرداخت', 'رفع اختلاف کامل ماده ۲۳۸', 'عدم اعتراض پس از ابلاغ واقعی', 'تأیید برگ و قبول مؤدی'] },
          { id: 'pit-050-f4', label: 'مالیات قطعی', key: 'final_tax', type: 'number', required: true },
          { id: 'pit-050-f5', label: 'پرداخت‌های قبلی', key: 'previous_payments', type: 'number', required: false },
          { id: 'pit-050-f6', label: 'مانده بدهی', key: 'balance_due', type: 'number', required: true },
          { id: 'pit-050-f7', label: 'اضافه‌پرداخت', key: 'overpayment', type: 'number', required: false },
          { id: 'pit-050-f8', label: 'فایل برگ قطعی', key: 'final_notice_file', type: 'file', required: false },
        ],
      },
      {
        id: 'pit-051',
        title: 'PIT-051: پرداخت مالیات قطعی (مهلت ۱۰ روزه)',
        base_event: 'تاریخ ابلاغ برگ/ااختیاریه',
        gap_value: 10,
        gap_unit: 'روز',
        step_nature: 'MANDATORY',
        actor: 'TAXPAYER',
        note: 'مؤدی باید ظرف ۱۰ روز از تاریخ ابلاغ برگ قطعی مالیات را پرداخت کند. عملیات اجرایی پس از عدم پرداخت خارج از محدوده فعلی است.',
        fields: [
          { id: 'pit-051-f1', label: 'مالیات قطعی', key: 'final_tax', type: 'number', required: true },
          { id: 'pit-051-f2', label: 'مبلغ پرداخت‌شده', key: 'amount_paid', type: 'number', required: false },
          { id: 'pit-051-f3', label: 'تاریخ پرداخت', key: 'payment_date', type: 'date', required: false },
          { id: 'pit-051-f4', label: 'شناسه پرداخت', key: 'payment_id', type: 'text', required: false },
          { id: 'pit-051-f5', label: 'درخواست تقسیط', key: 'installment_request', type: 'checkbox', required: false },
          { id: 'pit-051-f6', label: 'رسید پرداخت', key: 'payment_receipt', type: 'file', required: false },
        ],
      },
    ],
