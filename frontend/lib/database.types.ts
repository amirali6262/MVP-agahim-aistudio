...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      create_obligation_family: {
        Args: { requested_code: string; requested_title: string; requested_domain: string }
        Returns: Database["public"]["Tables"]["obligation_families"]["Row"]
      }
      delete_obligation_definition: {
        Args: { requested_obligation_id: string }
        Returns: undefined
      }
      delete_workflow_step_definition: {
        Args: { requested_step_id: string }
        Returns: undefined
      }
      complete_case_task: {
