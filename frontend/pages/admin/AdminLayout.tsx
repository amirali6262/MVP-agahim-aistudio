...
export default function AdminLayout({ children }: Props) {
  ...
  const routeLabels: Record<string, string> = {
    ...
    '/admin/company-info': 'طراحی اطلاعات شرکت', '/admin/selection-lists': 'فهرستهای انتخابی', '/admin/company-menu': 'مدیریت منوی فضای شرکت', '/admin/system-keys': 'فهرست کلیدهای سیستم', '/admin/tax/corporate': 'مالیات بر عملکرد اشخاص حقوقی',
